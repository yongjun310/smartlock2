...
public class IconEditText extends EditText implements
...
//        	throw new NullPointerException("You can add drawableRight attribute in XML");
            mClearDrawable = getResources().getDrawable(R.drawable.icon_edit);
        }
    ...
    public void onFocusChange(View v, boolean hasFocus) {
        ...
        if (hasFocus) {
            ...
            margin.setMargins(0, DisplayUtils.dip2px(this.getContext(), 111), 0, 0); //7px bottom margin
            this.setLayoutParams(margin);
        } else {
            margin.setMargins(DisplayUtils.dip2px(this.getContext(), 63), DisplayUtils.dip2px(this.getContext(), 111), DisplayUtils.dip2px(this.getContext(), 63), 0);
            setClearIconVisible(false);
        }
    }
